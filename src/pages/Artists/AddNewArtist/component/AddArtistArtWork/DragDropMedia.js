    ...
    return (
        <>
            <Box width={'90%'} m={'auto'} pt={'2rem'} pb={'6rem'} mb={'auto'}>
                <BioRymHeading textAlign={'center'} >Add artworks to artist profile</BioRymHeading>
                ...
                <Grid templateColumns="repeat(1, 1fr)" gap={6}  pt={'3rem'}>
                    <Box border={'2px dashed #ADADAD'} width={'100%'} height={'300px'} display={'flex'} flexDirection={'column'} alignItems={'center'} justifyContent={'center'} >
                        <SppinnerMain>
                            <SppinnerInner/>
                            <SppinnerNummber>100%</SppinnerNummber>
                            <SppinnerBar>
                                <SppinnerBarProgress></SppinnerBarProgress>
                            </SppinnerBar>
                        </SppinnerMain>
                        <Heading mt={'1rem'} color={'#1A1A1A'} fontSize={'1.25rem'} fontWeight={'700'}>Loading.....</Heading>
                        <Icon  width='100%'   height="30" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Heading mb={'0.5rem'} textAlign='center' color={'#333333'} pt='0.5rem' fontSize='1.25rem'>Click or drag your file to this area to upload.</Heading>
                        <Text fontSize={'14px'}  color={'#333333'}>Lorem ipsum dolor sit atmet, consectetur adipiscing elit.</Text>
                    </Box>
