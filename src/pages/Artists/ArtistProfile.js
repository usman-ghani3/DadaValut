...
if(loader)
{
                            ...
                            <Box p={0}  width={'100%'} >
                                <Flex mb={'2rem'}  width={'100%'} >
                                   <Box>
                                       ...
                                       <Image src={`https://api.dadavault.com/api/users/artist_profile/${artistDataa?.artist_head_shot}`} width={'64px'} height={'64px'} objerctFit={'cover'} borderRadius={'99999px'}/>
                                   </Box>
                                </Flex>
                            </Box>
    ...
    <Box display='flex'  alignItems='center' justifyContent='center' width={'64px'} height={'64px'} position={'relative'}  borderRadius={'50px'} border={'1px solid #c4c4c4'}>
        <Image  src= {url?url:`https://api.dadavault.com/api/users/artist_profile/${artistDataa?.artist_head_shot}`} objectFit={'cover'} maxH={'100%'} width={'100%'} borderRadius={'50px'} height={'100%'} />
               ...
               {formikProps.errors.nationality}
                                    ...
                                    <Box mb={'2rem'}>
                                        ...
                                        <Input
                                            ...
                                            bg={'#fff'}
                                            borderRadius={'0'}
                                            borderColor={(formikProps.errors.birth && formikProps.touched.birth)?'#DD2922': ' #D2D2D2'}
                                         border={(formikProps.errors.birth && formikProps.touched.birth)?'2px solid #DD2922': '1px solid #D2D2D2'}
                                            color={'#636262'}
                                            name="birth"
                                            id ="birth"
               ...
               {formikProps.errors.bio}
                         ...
                         setURL("")
                                ...
                                <Button mb={3} bg='#0C0B86' color='#fff' borderRadius={'0px'}  _focus={{ bg: "#090864", }}  _hover={{ bg: "#0C0B86", }} _active={{ bg: "#090864", }}
                                        ...
                                        isDisabled={(formikProps?.values?.nationality && formikProps?.values?.birth && formikProps?.values?.bio)?false:true}
