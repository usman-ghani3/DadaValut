                ...
                <Box as='section' bg={'#F7F7F7'} className='Login'>
                    <Flex height='100vh' overflowY={'scroll'} >
                        <Container display={'flex'} flexDirection={'column'}  align='center' justifyContent='center'  direction="column"  minHeight='100vh'>
                            ...
                            <Box mt={'2rem'} pb={0} mb={0}>
                                <BioRymHeading color="#201F1F" fontSize='2.25rem' pt='1.5rem' mb='1rem'  fontWeight='700' lineHeight={'43.6px'} >Reset your password</BioRymHeading>
                                <Text display={'flex'} alignItmes={'center'} marginBottom={'2rem'} justifyContent={'center'} lineHeight={'24px'} pb={0} fontSize='16px' fontWeight={'400'} color={'#797979'}> Have a password reset link sent to your email address</Text>
                            ...
                            <Box mb={'auto'} className="Box-card" py='2rem' px={'2.5rem'} bg='#fff' borderRadius='0' boxShadow={'0px 1px 3px rgba(32, 31, 31, 0.1), 0px 1px 2px rgba(32, 31, 31, 0.06)'}  >
                                ...
                                <Flex mb={'2rem'}>
                                    {!showNext?
                                    <Link onClick={handleBackLogin}  color='#4D4D4D' fontWeight='500' display='flex' alignItems={'center'} justifyContent={'center'} color={'#0F0EA7'} fopntWeight={'500'} ><IoIosArrowBack /> <Text as='span'  ml={'7px'}> Back to sign in</Text></Link>
                                    :
                                    <Link onClick={handleBackForgot}  color='#4D4D4D' fontWeight='500' display='flex' alignItems={'center'} justifyContent={'center'} color={'#0F0EA7'} fopntWeight={'500'} ><IoIosArrowBack /> <Text as='span'  ml={'7px'}> Back to forgot password</Text></Link>
                                    }
                                </Flex>
                                {showNext?
                                <Box textAlign={'left'}>
                                    <Text  color='#636262' mb={'0.5rem'} fontWeight='500' >Check your email</Text>
                                    <Text color='#636262' fontWeight={'400'} fontSize={'16px'} >You will receive an email with instructions to reset your password.</Text>
                                </Box>
                                :
                                <>
                                <FormControl>
 ...
 <div>
          {formikProps.errors.email && formikProps.touched.email && (
               ...
               {formikProps.errors.email}
                                    ...
                                    <Button  py='1.5rem' w='100%' mt='1rem' borderRadius={'0px'} bg='#0F0EA7' color='#fff' _focus={{ bg: "#090864", }}  _hover={{ bg: "#0C0B86", }} _active={{ bg: "#090864", }}

                                            isDisabled={!formikProps?.values?.email?true:false}
                                             onClick={formikProps.handleSubmit}>Reset password</Button>                            </FormControl>
                                    </>
}
                            </Box>
