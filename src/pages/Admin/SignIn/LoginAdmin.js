...
import {Alert, AlertIcon, Divider, Icon, Link, SimpleGrid, VisuallyHidden} from "@chakra-ui/react";
import {
    Heading,
    Spacer,
    FormLabel,
    ...
    Box,
    ChakraProvider,
    Flex , Input , FormHelperText,Text
                ...
                <Flex height='100vh' overflowY={'scroll'} >
                    <Container align='center' justifyContent='center' direction="column">
                        ...
                        <Box my={'auto'} pb={0} mb={0}>
                            <BioRymHeading color="#000" fontSize='2.25rem' pt='1.5rem' mb='1rem'  fontWeight='700' lineHeight={'44px'} >Admin Login</BioRymHeading>
                            <Text display={'flex'} alignItmes={'center'} justifyContent={'center'} pb={0} fontSize='16px' fontWeight={'400'} lineHeight={'24px'} color={'#797979'}  mb={'2rem'}>Sign in to the DadaVault Admin portal </Text>
                        </Box>
                        <Box my={'auto'} className="Box-card" p='2rem'  bg='#fff' borderRadius='0' >

                            <FormControl id="email" display={'flex'} flexDirection={'column'}>
                                ...
                                <Flex >
                                    ...
                                    <Spacer />
                                    <Link color={'#0F0EA7'} fontSize={'16px'} ml={'auto'} fontWeight={500} >
                                        Forgot Password?
                                    </Link>
                                </Flex>
                                <InputGroup size="md" mb={3}>
                                    ...
                                    <InputRightElement width="4.5rem">
                                        <Button _focus={{ bg: "transparent", }}  _hover={{ bg: "transparent", }} _active={{ bg: "transparent", }} bg='transparent' h="1.75rem" size="sm" onClick={handleClick} color={'#636262'}>
                                            {show ? <i className="fas fa-eye"></i>: <i className="fas fa-eye-slash"></i>}
                                        </Button>
                                    </InputRightElement>
                                </InputGroup>
                                <Button maxW={'102px'} ml={'auto'}  py='1.5rem' w='100%' my='1rem' borderRadius={'0px'} bg='#0F0EA7' color='#fff' _focus={{ bg: "#0F0EA7", }}  _hover={{ bg: "#0F0EA7", }} _active={{ bg: "#0F0EA7", }}
