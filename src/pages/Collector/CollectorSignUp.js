  ...
  return (
        ...
        <Box as='section' bg={'#F7F7F7'} className='Login'>
            <Flex  overflowY={'scroll'} >
                <Container display={'flex'} flexDirection={'column'}    direction="column"  minHeight='100vh'>
                    ...
                    <Box mt={'22px'} pb={0} mb={0}>
                        <Heading textAlign={'center'} color="#363535" fontSize='2rem'  mb='0.5rem'  fontWeight='700'  lineHeight={'32px'}>Check your email</Heading>
                        <Text display={'flex'} textAlign={'center'}  marginBottom={'2.5rem'} justifyContent={'center'} pb={0} fontSize='16px' fontWeight={'400'} color={'#797979'} lineHeight='24px'>

                                                
                        A verification link has been sent to the email address you entered when creating your account.
                        <br/>
                        <br/>
                        ...
                        If you don’t see the email, check your spam folder.        
                            ...
                            <Button display={'flex'}  mx={'auto'}  maxW={'194px'}  minW={'194px'} py='1.5rem' border={'1px solid #D2D2D2'} w='100%' mt='1rem' borderRadius={'0px'} bg='transparent' color='#201F1F' _focus={{ bg: "#fff", }}  _hover={{ bg: "#fff", }} _active={{ bg: "#fff", }}
...
<>
                 ...
                 <Flex  overflowY={'scroll'} >
                     <Container display={'flex'} flexDirection={'column'}   minHeight='100vh'>
                         ...
                         <Box mt={'32px'} pb={0} mb={0}>
                             <BioRymHeading color="#000" fontSize='2.25rem' pt='1.5rem' mb='1rem'  fontWeight='700' >Create a DadaVault account</BioRymHeading>
                             <Text display={'flex'} alignItmes={'center'} marginBottom={'2rem'} justifyContent={'center'} pb={0} fontSize='16px' fontWeight={'400'} color={'#797979'}>

                             Already have an account? <Link onClick={()=>{
                               navigate("/Login")
                             }} color={'#0F0EA7'} fontWeight={'500'} pl={2}> Log in </Link>
                         ...
                         <Box  mb={5} className="Box-card" p='2rem' bg='#fff' borderRadius='0' boxShadow={'0px 1px 3px rgba(32, 31, 31, 0.1), 0px 1px 2px rgba(32, 31, 31, 0.06)'}  >
                             <FormControl>
                                 <FormLabel color='#636262' fontWeight='500' >Email address</FormLabel>
                                 <InputGroup size="md" minH={'2rem'} mb={'2rem'}>
                                     <Input color={'#636262'}
                                            borderRadius={'0'}
          ...
          {formikProps.errors.email && formikProps.touched.email && (
               ...
               {formikProps.errors.email}
                                 ...
                                 {/*<Text fontSize={'14px'} fontWeight={'400'} color={'#8F8F8F'} textAlign={'left'} >Contact DadaVault if you need to change this.</Text>*/}
                                 <FormLabel color='#636262' fontWeight='500' >Password</FormLabel>
                                 <InputGroup size="md" mb={3}>
                                     ...
                                     <InputRightElement width="4.5rem">
                                         <Button _focus={{ bg: "transparent", }}  _hover={{ bg: "transparent", }} _active={{ bg: "transparent", }} bg='transparent' h="1.75rem" size="sm" onClick={handleClick} color={'#b3b3b2'}>
                                             {show ?   <IoMdEye/> : <IoMdEyeOff/>}
                                         </Button>
                                     </InputRightElement>
                                 </InputGroup>
                                 <Text fontSize={'14px'} fontWeight={'400'} color={'#8F8F8F'} textAlign={'left'} >Minimum 8 characters</Text>
                                 <div>
          {formikProps.errors.password && formikProps.touched.password && (
               <Alert status='error' color={'#DD2922'} pl={0} fontWeight={'400'} fontSize={'14px'} lineheight={'20px'}>
               ...
               {formikProps.errors.password}
                                 ...
                                 <FormLabel mt={'2rem'} color='#636262' fontWeight='500' >Disclosures</FormLabel>
                                 <Flex >
                                     <Box mb={'40px'}>
                                         <FormLabel color='#636262' fontWeight='400' display={'flex'}  >
                                             <Checkbox display={'block'} verticalAlign={'middle'} variant="red" color='#636262' mr={'24px'}
                                         ...
                                         >
                                                ...
                                                <Text mt={'-4px'} color='#636262' fontWeight='400' >I have read and accepted the DadaVault <Link>Privacy Policy</Link> and <Link>Terms & Conditions</Link>. </Text></FormLabel>
                                     </Box>
          ...
          {formikProps.errors.checkbox && formikProps.touched.checkbox && (
               ...
               {formikProps.errors.checkbox}
                                 ...
                                 <Button display={'flex'} alignItems={'center'} justifyContent={'flex-end'} ml={'auto'}  maxW={'145px'} py='1.5rem' w='100%' my='1rem' borderRadius={'0px'} bg='#0F0EA7' color='#fff' _focus={{ bg: "#090864", }}  _hover={{ bg: "#0C0B86", }} _active={{ bg: "#090864", }}
                                         ...
                                         onClick={formikProps.handleSubmit} isDisabled={!(formikProps?.values.email && formikProps?.values?.password && formikProps?.values?.checkbox) ?true:false}>Create Account</Button>
                             </FormControl>
                         </Box>
