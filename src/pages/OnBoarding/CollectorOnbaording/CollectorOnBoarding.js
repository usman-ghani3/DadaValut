...
function CollectorOnBoarding(props) {
    ...
    const handleContinue =async(values, resetForm) => {
        ...
        bodyFormData.append('collector_signUp_step', 1);
        ...
        try  { 
            ...
            //    alert(JSON.stringify(data))
              if(data){
                ...
                navigate('/CollectorPaymentGateway', { state: { value: email,file:coverArt }});
        ...
        <>
            <Box as='section' bg={'#F7F7F7'} className='Login'>
                <Flex overflowY={'scroll'}>
                    <Box as='section' mx={'auto'}  py="16" px={{ md: '8' }} display={'flex'} flexDirection={'column'}  align='center' justifyContent='center'  direction="column"  minHeight='100vh'>
                        <Flex mx='auto' mb={'4.5rem'}>
                        ...
                        <Box pb={0} mb={0}>
                            <Heading color="#363535" fontSize='1.5rem' pt='1.5rem' mb='0.5rem'  fontWeight='700' lineHeight={'32px'} >Create your collector profile</Heading>
                            <Text display={'flex'} alignItmes={'center'} justifyContent={'center'} pb={'2rem'} fontSize='16px'  lineHeight={'24px'} fontWeight={'400'} color={'#797979'} >Add more details about yourself. This will be visible to galleries that you transact with.</Text>
                        </Box>
                        <Box className="Box-card" p='2rem' maxW="3xl" mx="auto" bg='#fff' borderRadius='0.5rem' width={'100%'} minW={{base: "98%", sm:"98%", md: "98%", lg: "784px" ,xl:'784px'}}>
                            ...
                            <FormControl >
                                <Box>
                                    <FormLabel color='#636262' fontWeight='500' >Profile Picture</FormLabel>
                                    <Box display='flex'  alignItems='center' justifyContent='start' mb={8}>
                                        ...
                                        {url===""?
                                            ...
                                            <Box  display='flex'  alignItems='start' justifyContent='start'>
                                                ...
                                                <Box display='flex'  alignItems='center' justifyContent='center' width={'64px'} height={'64px'} position={'relative'}  borderRadius={'50px'} border={'1px solid #c4c4c4'}>
                                                    <Image width={'100%'} borderRadius={'50px'} objectFit={"cover"} maxWidth={'100%'} height={'100%'}
                                                           src= {url}/>
                                        ...
                                        <Text color={'#797979'} fontWeight={'400'} pl={'1rem'}>Change your profile picture</Text>
                                    </Box>
                                </Box>
                                <Box mb={'2rem'} width={{base:'100%',sm:'100%' , md:'100%' , lg:'50%' , xl:'50%'}}>
                                    <Text textAlign={'left'} color='#636262' fontWeight='500' >Full Name</Text>
                                        <Input
                                       color={'#636262'}
                                       type="text"
                                       bg={'#fff'}
                                ...
                                <Box mb={'2.5rem'} width={{base:'100%',sm:'100%' , md:'100%' , lg:'50%' , xl:'50%'}}>
                                    <Text textAlign={'left'} color='#636262' fontWeight='500' >Email Address</Text>
                                    <Input
                                        type="email"                                        
                                        bg={'#fff'}
                                        borderRadius={'0'}
                            ...
                            <Box display={'flex'} >
                                ...
                                isDisabled={(formikProps?.values?.name)?false:true}
                                > Continue  </Button>
