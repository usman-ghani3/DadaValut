            ...
            <Box overflowX={'scroll'}>
                <Table border={'1px solid #C4C4C4'} borderCollapse={'separate'} borderSpacing={'0'} cellPadding={0} cellPadding={0} p={0} borderRadius={'12px'}>
                    <Thead borderBottom={'1px solid #C4C4C4'}>
                        <Tr>
                            <Th fontSize={'1.12rem'} color={"#1A1A1A"} textTransform={'captilize'} width={'38%'}>Payment Information</Th>
                            <Th textAlign={'right'}>
                    ...
                    <Tbody>
                        <Tr bg={'#F2F2F2'}>
                            <Td color={'#333333'} fontSize={'16px'}>Name on card</Td>
                            <Td fontWeight={'600'}>Adam Adelson</Td>
                        </Tr>
                        <Tr>
                            <Td  color={'#333333'} fontSize={'16px'}>Card Details</Td>
                            <Td fontWeight={'600'}>•••• •••• •••• 1234          05 / 26          789</Td>
                        </Tr>
                        <Tr  bg={'#F2F2F2'}>
                            <Td  color={'#333333'} fontSize={'16px'}>Billing Address</Td>
                            <Td fontWeight={'600'}>318 Worth Ave, Palm Beach, FL 33480</Td>
                        </Tr>
                        <Tr>
                            <Td  color={'#333333'} fontSize={'16px'}>Amount to be charged</Td>
                            <Td fontWeight={'600'}>$348</Td>
                        </Tr>
                    </Tbody>
                    <Tfoot>
                        <Tr>
